...
players quick travel between different areas.
...
the player enters the outside teleporter, the player will be teleportered to the inside teleporter
in the cafe. 

To create your own teleporters, there is a Teleporter template that can be used. The template containts
...
- Name
  The name of the teleporter being transferred to.

======================
Connecting Teleporters
======================

Connecting up teleporters is very easy.
...
Teleporters can be chained very easily. For example, going from A to B, B to C and so on.
--]]